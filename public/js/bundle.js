...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name, email, contact, password, passwordConfirm) {
    var res;
...
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"createQuestion.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.searchQuestion = exports.deleteQuestion = exports.createQuestion = void 0;
...
var createQuestion = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(question, subject, userId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Question Generated successfully');
              window.setImmediate(function () {
                location.assign('/');
              }, 500);
            }
...
var searchQuestion = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(question, subject) {
    var url;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            try {
              if (subject === '' && question != '') {
                url = "/search-question-question/".concat(encodeURIComponent(question));
              } else if (subject != '' && question == '') {
                url = "/search-question-subject/".concat(encodeURIComponent(subject));
              } else if (subject != '' && question != '') {
                url = "/search-question/".concat(encodeURIComponent(subject), "/").concat(encodeURIComponent(question));
              }

              window.setTimeout(function () {
                location.assign("".concat(url));
              }, 100);
            } catch (err) {
  ...
  return function searchQuestion(_x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteQuestion = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(questionId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/questions/".concat(questionId)
            });
          ...
          case 4:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'Question was succesfully deleted!');
              window.setTimeout(function () {
          ...
          case 8:
            _context3.prev = 8;
            _context3.t0 = _context3["catch"](0);
            (0, _alerts.showAlert)('error', 'Error with deleting Question!');
  ...
  return function deleteQuestion(_x6) {
    return _ref3.apply(this, arguments);
  };
}();

exports.deleteQuestion = deleteQuestion;
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"createAnswer.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatelikeAnswer = exports.editAnswer = exports.deleteAnswer = exports.createAnswer = void 0;
...
var createAnswer = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(answer, question, user) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/questions/".concat(question, "/answers"),
              data: {
                answer: answer,
                question: question,
                user: user
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Answer was succesfully uploaded!');
              window.setTimeout(function () {
                location.reload(true);
              }, 500);
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'You can leave only one Answer.');
  ...
  return function createAnswer(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var editAnswer = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(answer, answerId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/answers/".concat(answerId),
              data: {
                answer: answer
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Answer was succesfully edited!');
              window.setTimeout(function () {
                location.reload(true);
              }, 1000);
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', 'Error with editing answer!');
  ...
  return function editAnswer(_x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteAnswer = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(answerId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'answer was succesfully deleted!');
              window.setTimeout(function () {
                location.reload(true);
              }, 600);
            }
          ...
          case 7:
            _context3.prev = 7;
            _context3.t0 = _context3["catch"](0);
            (0, _alerts.showAlert)('error', 'Error with deleting answer!');
  ...
  return function deleteAnswer(_x6) {
    return _ref3.apply(this, arguments);
  };
}();
...
var updatelikeAnswer = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(likes, answerId) {
    var res;
  ...
  return function updatelikeAnswer(_x7, _x8) {
...
exports.upgradeTutor = exports.updateSettings = exports.deleteUser = exports.banTutor = void 0;
...
var upgradeTutor = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(role, appliedStatus, tutorId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/".concat(tutorId),
              data: {
                role: role,
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'User was succesfully edited!');
              window.setTimeout(function () {
                location.reload(true);
              }, 1000);
            }
  ...
  return function upgradeTutor(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();

exports.upgradeTutor = upgradeTutor;

var banTutor = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(active, restrictions, tutorId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'User was succesfully banned!');
              window.setTimeout(function () {
                location.reload(true);
              }, 200);
            }
          ...
          case 7:
            _context3.prev = 7;
            _context3.t0 = _context3["catch"](0);
            (0, _alerts.showAlert)('error', 'Error with banning User!');
            window.setTimeout(function () {
              location.reload(true);
            }, 200);
  ...
  return function banTutor(_x6, _x7, _x8) {
    return _ref3.apply(this, arguments);
  };
}();

exports.banTutor = banTutor;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/users/".concat(noteId)
            });
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'User was succesfully deleted!');
              window.setTimeout(function () {
                location.reload(true);
              }, 600);
            }
          ...
          case 7:
            _context4.prev = 7;
            _context4.t0 = _context4["catch"](0);
            (0, _alerts.showAlert)('error', 'Error with deleting user!');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"uploadNote.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uploadNote = exports.filterNotes = exports.deleteNote = void 0;
...
var uploadNote = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Note Created Successfully');
              window.setImmediate(function () {
                // location.assign('/');
  ...
  return function uploadNote(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteNote = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(noteId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'Note was succesfully deleted!');
              window.setTimeout(function () {
                location.reload(true);
              }, 600);
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', 'Error with deleting Note!');
...
var filterNotes = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(subject, className) {
    var url;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            try {
              if (subject === '' && className != '') {
                url = "/view-notes-className/".concat(encodeURIComponent(className));
              } else if (subject != '' && className == '') {
                url = "/view-notes-subject/".concat(encodeURIComponent(subject));
              } else if (subject != '' && className != '') {
                url = "/view-notes/".concat(encodeURIComponent(subject), "/").concat(encodeURIComponent(className));
              }
              ...
              (0, _alerts.showAlert)('error', 'Error with Filtering Note!');
            }
  ...
  return function filterNotes(_x4, _x5) {
    return _ref3.apply(this, arguments);
  };
}();

exports.filterNotes = filterNotes;
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"createBlog.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteBlog = exports.createBlog = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Blog Created Successfully');
              window.setImmediate(function () {
                // location.assign('/');
...
var deleteBlog = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(blogId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/blogs/".concat(blogId)
            });
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'Blog was succesfully deleted!');
              window.setTimeout(function () {
                location.reload(true);
              }, 600);
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', 'Error with deleting Blog!');
  ...
  return function deleteBlog(_x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deleteBlog = deleteBlog;
},{"./alerts":"alerts.js","axios":"../../node_modules/axios/index.js"}],"createEnquiry.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteEnquiry = exports.createEnquiry = void 0;
...
var createEnquiry = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, contact, message) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Messsage Sent Successfully');
              window.setImmediate(function () {
                location.assign('/');
              }, 500);
            } else {}
  ...
  return function createEnquiry(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteEnquiry = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(enquiryId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/enquiries/".concat(enquiryId)
            });
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'Enquiry was succesfully deleted!');
              window.setTimeout(function () {
                location.reload(true);
              }, 500);
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', 'Error with deleting Enquiry!');
  ...
  return function deleteEnquiry(_x5) {
    return _ref2.apply(this, arguments);
  };
}();
...
var _createQuestion = require("./createQuestion");

var _createAnswer = require("./createAnswer");

var _updateSettings = require("./updateSettings");

var _uploadNote = require("./uploadNote");

var _createBlog = require("./createBlog");

var _createEnquiry = require("./createEnquiry");
...
var logOutBtn = document.querySelector('.nav__el--logout'); // account form

var userDataForm = document.querySelector('.form-user-data');
var userApplyTutorForm = document.querySelector('.form-apply-tutor');
var userPasswordForm = document.querySelector('.form-user-password'); // const upgradeTutorForm = document.querySelector('.form-tutor-upgrade');

var upgradeTutorForm = document.querySelector('.form-tutor-upgrade'); // Notes form

var uploadNotesForm = document.querySelector('.form-upload-note');
var notesFilter = document.querySelector('.notesFilter'); // Blog form

var createBlogForm = document.querySelector('.form-upload-blog'); // Enquiry form

var createEnquiryForm = document.querySelector('.form-enquiry'); // Question form

var askQuestionForm = document.querySelector('.form-ask-question');
var searchQuestionForm = document.querySelector('.form-search-question');
var searchQuestionFormIndex = document.querySelector('.search-question-index');
var answerDataForm = document.querySelector('.answer--form'); // const reviewDataForm = document.querySelector('.review--form');
// const bookBtn = document.getElementById('book-tour');
// const reviews = document.querySelector('.reviews');

var answersEdit = document.querySelector('.answer__edit');
var answersUpdate = document.querySelector('.answersUpdate');
var answersDelete = document.querySelector('.answersDelete'); // const notesDelete = document.querySelector('.notesDelete');
...
var blogdel = document.querySelector('.blogdel');
var enquiries = document.querySelector('.enquiries');
var questiondel = document.querySelector('.questiondel'); // if (mapBox) {
//   const locations = JSON.parse(mapBox.dataset.locations);
//   displayMap(locations);
// }

if (notes) notes.addEventListener('click', function (e) {
  if (e.target.tagName === 'BUTTON') {
    var button = e.target; // const noteCard = button.closest('.note__card');
    // const note = noteCard.parentNode;

    if (button.textContent === 'Delete') {
      var noteId = button.dataset.noteId;
      (0, _uploadNote.deleteNote)(noteId);
    }
  }
});
if (blogdel) blogdel.addEventListener('click', function (e) {
  if (e.target.tagName === 'BUTTON') {
    var button = e.target; // const noteCard = button.closest('.note__card');
    // const note = noteCard.parentNode;

    if (button.textContent === 'Delete') {
      var blogId = button.dataset.blogId;
      (0, _createBlog.deleteBlog)(blogId);
    }
  }
});
if (enquiries) enquiries.addEventListener('click', function (e) {
  if (e.target.tagName === 'BUTTON') {
    var button = e.target; // const noteCard = button.closest('.note__card');
    // const note = noteCard.parentNode;

    if (button.textContent === 'Delete') {
      var enquiryId = button.dataset.enquiryId;
      (0, _createEnquiry.deleteEnquiry)(enquiryId);
    }
  }
});
if (answers) answers.addEventListener('click', function (e) {
  if (e.target.tagName === 'BUTTON') {
    var button = e.target; // const noteCard = button.closest('.note__card');
    // const note = noteCard.parentNode;
    ...
    if (button.textContent === 'Delete') {
      ...
      (0, _createAnswer.deleteAnswer)(answerId);
    }
  }
});
if (questiondel) questiondel.addEventListener('click', function (e) {
  if (e.target.tagName === 'BUTTON') {
    var button = e.target; // const noteCard = button.closest('.note__card');
    // const note = noteCard.parentNode;
    ...
    if (button.textContent === 'Delete') {
      ...
      (0, _createQuestion.deleteQuestion)(questionId);
    }
  }
});
if (upgradeTutorForm) upgradeTutorForm.addEventListener('click', function (e) {
  if (e.target.tagName === 'BUTTON') {
    var button = e.target; // const noteCard = button.closest('.note__card');
    // const note = noteCard.parentNode;

    if (button.textContent === 'Delete') {
      var tutorId = button.dataset.nuserId;
      (0, _updateSettings.deleteUser)(tutorId);
    } else if (button.textContent === 'Upgrade') {
      var _tutorId = button.dataset.nuserId;
      var _role = 'teacher';
      var appliedStatus = '';
      (0, _updateSettings.upgradeTutor)(_role, appliedStatus, _tutorId);
    } else if (button.textContent === 'Downgrade') {
      var _tutorId2 = button.dataset.nuserId;
      var _role2 = 'user';
      var _appliedStatus = '';
      (0, _updateSettings.upgradeTutor)(_role2, _appliedStatus, _tutorId2);
    } else if (button.textContent === 'Cancel Request') {
      var _tutorId3 = button.dataset.nuserId;
      var _appliedStatus2 = '';
      (0, _updateSettings.upgradeTutor)(role, _appliedStatus2, _tutorId3);
    } else if (button.textContent === 'Ban') {
      var _tutorId4 = button.dataset.nuserId;
      var active = 'false';
      var restrictions = 'banned';
      (0, _updateSettings.banTutor)(active, restrictions, _tutorId4);
    } else if (button.textContent === 'Remove ban') {
      var _tutorId5 = button.dataset.nuserId;
      var _active = 'true';
      var _restrictions = '';
      (0, _updateSettings.banTutor)(_active, _restrictions, _tutorId5);
    }
  }
});
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _login.signup)(name, email, contact, password, passwordConfirm);
  });
}

if (createEnquiryForm) {
  createEnquiryForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('name').value;
    var email = document.getElementById('email').value;
    var contact = document.getElementById('contact').value;
    var message = document.getElementById('message').value;
    (0, _createEnquiry.createEnquiry)(name, email, contact, message);
  });
}
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  form.append('teachingExperience', document.getElementById('teachingExperience').value);
  form.append('desiredClass', document.getElementById('desiredClass').value);
  form.append('photo', document.getElementById('photo').files[0]);
  console.log(form);
  (0, _updateSettings.updateSettings)(form, 'data');
});
if (userApplyTutorForm) userApplyTutorForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  form.append('teachingExperience', document.getElementById('teachingExperienceE').value);
  form.append('desiredClass', document.getElementById('desiredClassE').value); // form.append('cv', document.getElementById('cv').files[0]);
...
if (notesFilter) {
  notesFilter.addEventListener('submit', function (e) {
    e.preventDefault();
    var subject = document.getElementById('subject').value;
    var className = document.getElementById('className').value;
    (0, _uploadNote.filterNotes)(subject, className);
  });
}

if (uploadNotesForm) uploadNotesForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  form.append('name', document.getElementById('name').value);
  ...
  (0, _uploadNote.uploadNote)(form, 'data');
});
if (createBlogForm) createBlogForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData();
  form.append('blogHeading', document.getElementById('blogHeading').value);
  form.append('category', document.getElementById('category').value);
  form.append('blogSubContent', document.getElementById('blogSubContent').value);
  ...
  form.append('metaDescription', document.getElementById('metaDescription').value);
  ...
  (0, _createBlog.createBlog)(form, 'data');
});
...
if (askQuestionForm) {
  askQuestionForm.addEventListener('submit', function (e) {
    ...
    (0, _createQuestion.createQuestion)(question, subject, userId);
  });
}

if (searchQuestionForm) {
  searchQuestionForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var question = document.getElementById('question').value;
    var subject = document.getElementById('subject').value;
    (0, _createQuestion.searchQuestion)(question, subject);
  });
}

if (searchQuestionFormIndex) {
  searchQuestionFormIndex.addEventListener('submit', function (e) {
    e.preventDefault();
    var question = document.getElementById('question').value;
    var subject = document.getElementById('subject').value;
    (0, _createQuestion.searchQuestion)(question, subject);
...
if (answerDataForm) {
  answerDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var answer = document.getElementById('answer').value;
    var question = document.getElementById('questionId').value;
    var user = document.getElementById('userId').value; // const { user, question } = JSON.parse(reviewDataForm.dataset.ids);

    (0, _createAnswer.createAnswer)(answer, question, user);
  });
}

if (answersUpdate) {
  answersUpdate.addEventListener('submit', function (e) {
    e.preventDefault();
    var answer = document.getElementById('newanswer').value;
    var answerId = document.getElementById('answerId').value;
    (0, _createAnswer.editAnswer)(answer, answerId);
  });
}

if (answersDelete) {
  answersDelete.addEventListener('submit', function (e) {
    e.preventDefault();
    var answerIdDel = document.getElementById('answerIdDel').value;
    (0, _createAnswer.deleteAnswer)(answerIdDel);
  });
} // if (notesDelete) {
...
if (reviews) reviews.addEventListener('click', function (e) {
  if (e.target.tagName === 'BUTTON') {
    ...
    if (button.textContent === 'Delete') {
      ...
      editReview(+_inputRating2.value, _reviewText2.textContent, button.dataset.reviewId);
      button.textContent = 'Edit';
    }
  }
});
